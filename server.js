...
해석 가이드라인:
- 뽑힌 결과에 잘 부합하는 창의적이고 때로는 새로운 시각을 제공하는 운세 풀이
- 대학생들이 공감할 수 있는 현실적이고 유머러스하지만, 지친 학생들을 위로해주기도 하는 내용
- 2-3문장으로 간결하게
- 이모지 적절히 활용
- 긍정적이면서도 현실적인 톤
* 논란이 될 수 있는 커뮤니티 용어나 비속어는 사용 금지

예시 스타일:
"팀플이 카오스가 될 예정?! 🌪️ 하지만 다르게 생각해보면, 각자의 다양성이 도움이 될지도 모르는 법이죠🌈"
